function ShowCEP(IDProduto){
  ...
  if(sNumCEP==null)sNumCEP="";
   sCEP="<style>";
  sCEP+="/* Zip Code */";
  sCEP+=".ZipBackground{border:1px solid #eaeaea;background:#ffffff;padding:1px 1px 1px 1px;}";
  sCEP+=".ZipTitCalc{background-color:#eeedea;height:30px;font-size:9px;color:#fbfbfb;font-family:tahoma,verdana,arial;font-weight:bold}";
